...
{% highlight ruby %}
    ...
    [self.viewA setTranslatesAutoresizingMaskIntoConstraints:YES];
    [self.buttonA setTranslatesAutoresizingMaskIntoConstraints:YES];
    [self.viewB setTranslatesAutoresizingMaskIntoConstraints:YES];
    [self.buttonB setTranslatesAutoresizingMaskIntoConstraints:YES];
    ...
    [constraints addObject:[NSLayoutConstraint constraintWithItem:self.viewA attribute:NSLayoutAttributeLeading relatedBy:NSLayoutRelationEqual toItem:self.viewB attribute:NSLayoutAttributeTrailing multiplier:1.0 constant:0.0]];
